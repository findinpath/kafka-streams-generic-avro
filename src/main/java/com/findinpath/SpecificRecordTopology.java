 ...
 *
 * The events coming from the input topic will be deserialized as `SpecificRecord` objects.
 * It is therefor mandatory that all the types of the events coming over the input topic
 * find themselves in the classpath of the project.
 */
public class SpecificRecordTopology implements AutoCloseable {

  private static final Logger LOGGER = LoggerFactory.getLogger(SpecificRecordTopology.class);
  ...
  public SpecificRecordTopology(
    ...
    final KStream<String, SpecificRecord> records = builder.stream(inputTopic);
